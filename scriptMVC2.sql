...
CREATE DATABASE IF NOT EXISTS `mvc_tienda` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mvc_tienda`;
...
INSERT INTO `tbproducto` (`idproducto`, `nombre`, `descripcion`, `precio`, `stock`, `idmodelo`, `idcolor`, `idtalla`, `imagen`, `fecha_creacion`, `activo`) VALUES
	(1, 'Zapatillas Nike Air Force 1 Blancas', 'Zapatillas deportivas clásicas de cuero blanco', 299.90, 19, 1, 2, 13, NULL, '2025-10-20 04:09:20', 1),
	...
	(4, 'Pantalón Zara Tapered Negro', 'Pantalón de vestir ajustado color negro', 129.90, 28, 5, 1, 7, NULL, '2025-10-20 04:09:20', 1),
	(5, 'Blusa Zara Basic Blanca', 'Blusa básica femenina color blanco', 79.90, 39, 6, 2, 1, NULL, '2025-10-20 04:09:20', 1),
	(6, 'Zapatillas Nike Air Force 1 Negras', 'Zapatillas deportivas clásicas de cuero negro', 299.90, 13, 1, 1, 12, NULL, '2025-10-20 04:09:20', 1),
	(7, 'Camiseta Nike Dri-FIT Legend Blanca', 'Camiseta de entrenamiento blanca', 89.90, 35, 2, 2, 3, NULL, '2025-10-20 04:09:20', 1),
	(8, 'Zapatillas Adidas Ultraboost Negras', 'Zapatillas running negras', 399.90, 14, 3, 1, 14, NULL, '2025-10-20 04:09:20', 1),
	(9, 'Pantalón Adidas Tiro 21 Negro', 'Pantalones de entrenamiento deportivos', 149.90, 25, 4, 1, 2, NULL, '2025-10-20 04:09:20', 1),
	(10, 'Pantalón Zara Tapered Gris', 'Pantalón de vestir gris', 129.90, 19, 5, 6, 8, NULL, '2025-10-20 04:09:20', 1),
	...
	(20, 'Zapatillas Nike Air Force 1 Rojas', 'Zapatillas deportivas rojas', 299.90, 11, 1, 3, 14, NULL, '2025-10-20 04:09:20', 1);
...
-- Volcando datos para la tabla mvc_tienda.tbusuario: ~6 rows (aproximadamente)
INSERT INTO `tbusuario` (`idusuario`, `usuario`, `clave`, `nombre`, `apellido`, `email`, `idcargo`, `estado`, `fecha_registro`, `email_verificado`, `token_verificacion`, `fecha_creacion`) VALUES
	(1, 'admin', '123456', 'Juan', 'Pérez', 'admin@tienda.com', 1, 1, '2025-10-19 17:37:26', 1, NULL, '2025-10-23 22:13:07'),
	(2, 'gerente1', '123456', 'María', 'García', 'gerente@tienda.com', 2, 1, '2025-10-19 17:37:26', 1, NULL, '2025-10-23 22:13:07'),
	(3, 'vendedor1', '123456', 'Carlos', 'López', 'vendedor@tienda.com', 3, 1, '2025-10-19 17:37:26', 1, NULL, '2025-10-23 22:13:07'),
	(4, 'vendedor2', '123456', 'Ana', 'Martínez', 'ana@tienda.com', 3, 1, '2025-10-19 17:37:26', 1, NULL, '2025-10-23 22:13:07'),
	(5, 'cliente', '123456', 'Cliente', '2', 'ola@gmail.com', 4, 1, '2025-10-19 18:36:22', 1, NULL, '2025-10-23 22:13:07'),
	(11, 'usuario', 'qmfj akpl ygzd vxwd', 'fabricio', 'ramosss', 'rojomelodespojo@gmail.com', 4, 1, '2025-10-23 18:01:20', 1, NULL, '2025-10-23 23:01:20');
...
CREATE TABLE `vw_usuarios` (
	...
	`apellido` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
	`email` VARCHAR(100) NULL COLLATE 'latin1_swedish_ci',
	`idcargo` INT(11) NOT NULL,
	`cargo_nombre` VARCHAR(100) NOT NULL COLLATE 'latin1_swedish_ci',
